    ...
    <div className='project-container'>
      <h1>Projects</h1>
        <div className='project-card'>
            <img src={shoes} alt="shoes" height={200} />
            <h1>Step up Shoes</h1>
        ...
        <div className='project-card'>
            <img src={puppy} alt="puppy page" height={200} />
        ...
        <div className='project-card'>
            <img src={workout} alt="workout page" height={200} />
            <h1>Shape Up</h1>
        ...
        <div className='project-card'>
            <img src={travel} alt="travel page" height={200} />
            <h1>PLanet B</h1>
            <h3>Travel blog</h3>
        ...
        <div className='project-card'>
            <img src={fly} alt="fly page" height={200} />
            <h1>Fly with me</h1>
            <h3>Flight finder between Amsterdam, Stockholm and Oslo</h3>
            <p>Fly with me app is a full-stack application built using React that interacts with a flight finder backend application. 
              It only shows the flights between Stockholm, Amsterdam and Oslo. It fitlers the flights by the location, and the span that was chosen
              The database that was used includes only the 3 countries above but if it is expanded, it will work with them as well.
              </p>
            <button>Live demo</button>
            <button>Source code</button>
        </div>
        <div className='project-card'>
            <img src={tales} alt="tales page" height={200} />
            <h1>Tiny Tales</h1>
